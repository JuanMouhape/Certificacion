...
for (int i=1; i<=3;i++) {
	...
	WebUI.setText(findTestObject('Bucles/Page_DEMOQA/Page_DEMOQA/textarea_Current Address_currentAddress'), 'Pasaje San Luis'+ num )
	
	WebUI.setText(findTestObject('Bucles/Page_DEMOQA/Page_DEMOQA/textarea_Permanent Address_permanentAddress'), 'Bario Terminal Casa'+ num )
